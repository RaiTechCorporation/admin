                                    ...
                                    <div class="col-md-3 mb-3">
                                        <div class="mb-0 bg-secondary-lighten border p-2 rounded-3">
                                            ...
                                            <input type="file" id="logo_light" name="logo_light"
                                                class="form-control">
                                            <img class="mt-2" width="80" src="{{ asset('assets/img/logo-dark.png') }}"
                                                alt="">
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="mb-1">
                                            <label for="uri_scheme" class="form-label">{{ __('URI Schema') }} <button
                                                    ...
                                                    data-bs-content="Use your app name in lowercase with no spaces or special characters (e.g., Groovsta, cinereel, myapp2025).">
                                                    ?
                                                </button></label>
