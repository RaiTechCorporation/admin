...
Route::get('/api-docs', [SwaggerController::class, 'swaggerUI'])->name('swagger.ui');
Route::get('/swagger.json', [SwaggerController::class, 'swaggerJson'])->name('swagger.json');
Route::get('/swagger.yaml', [SwaggerController::class, 'swaggerSpec'])->name('swagger.yaml');
